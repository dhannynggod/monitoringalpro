...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/dropify/css/dropify.css">
  ...
  <?php
  } elseif ($this->uri->segment(2) == "detail_informasi") { ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/datatables/datatables.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/datatables/DataTables-1.10.16/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/datatables/Select-1.2.4/css/select.bootstrap4.min.css">
  <?php
  } elseif ($this->uri->segment(2) == "gmaps_simple" || $this->uri->segment(2) == "reporting" || $this->uri->segment(2) == "detail" || $this->uri->segment(2) == "detail_update") { ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/leaflet/leaflet.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/modules/dropzonejs/min/dropzone.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>assets/modules/leaflet-locatecontrol/dist/L.Control.Locate.min.css" />
    ...
    <script src="<?= base_url() ?>assets/modules/leaflet-locatecontrol/src/L.Control.Locate.js"></script>
  <?php
  ...
  <script>
    ...
    function changeStatus() {
      ...
      if (status.value == 'Belum') {
        document.getElementById("evs").style.display = "none";
      } else {
        document.getElementById("evs").style.display = "block";
      }
    }
